import{p as $,a5 as S,a4 as c,q as p,a6 as C,d as U,y as O,aU as Q,z as X,ak as Z,D as tt,bV as et,w as ot,x,o as rt,c as h,g as a,t as w,h as e,G as k,f as Y,F as q,r as P,aJ as st,u as nt,a as m,i as D,I as at}from"./entry.0e4a9e84.js";import V from"./moods.367e7c9e.js";const t="0!important",L="-1px!important";function g(s){return p(s+"-type",[c("& +",[$("button",{},[p(s+"-type",[C("border",{borderLeftWidth:t}),C("state-border",{left:L})])])])])}function _(s){return p(s+"-type",[c("& +",[$("button",[p(s+"-type",[C("border",{borderTopWidth:t}),C("state-border",{top:L})])])])])}const lt=$("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
